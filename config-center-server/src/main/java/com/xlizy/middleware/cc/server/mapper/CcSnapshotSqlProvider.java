...
import com.xlizy.middleware.cc.server.entity.CcSnapshotCriteria.Criteria;
import com.xlizy.middleware.cc.server.entity.CcSnapshotCriteria.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class CcSnapshotSqlProvider {


    public String countByExample(CcSnapshotCriteria example) {
    ...
    public String deleteByExample(CcSnapshotCriteria example) {

        SQL sql = new SQL();
        sql.DELETE_FROM("snapshot");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CcSnapshot record) {

        SQL sql = new SQL();
        sql.INSERT_INTO("snapshot");
        ...
        if (record.getEnvId() != null) {
            sql.VALUES("env_id", "#{envId,jdbcType=INTEGER}");
        }
        
        if (record.getCreateType() != null) {
            sql.VALUES("create_type", "#{createType,jdbcType=BIT}");
        }
    ...
    public String selectByExample(CcSnapshotCriteria example) {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        CcSnapshot record = (CcSnapshot) parameter.get("record");
        CcSnapshotCriteria example = (CcSnapshotCriteria) parameter.get("example");
        ...
        if (record.getEnvId() != null) {
            sql.SET("env_id = #{record.envId,jdbcType=INTEGER}");
        }
        
        if (record.getCreateType() != null) {
            sql.SET("create_type = #{record.createType,jdbcType=BIT}");
        }
    ...
    public String updateByPrimaryKeySelective(CcSnapshot record) {
        ...
        if (record.getEnvId() != null) {
            sql.SET("env_id = #{envId,jdbcType=INTEGER}");
        }
        
        if (record.getCreateType() != null) {
            sql.SET("create_type = #{createType,jdbcType=BIT}");
        }
    ...
    protected void applyWhere(SQL sql, CcSnapshotCriteria example, boolean includeExamplePhrase) {
