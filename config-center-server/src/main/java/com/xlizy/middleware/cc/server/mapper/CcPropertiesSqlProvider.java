...
import com.xlizy.middleware.cc.server.entity.CcPropertiesCriteria.Criteria;
import com.xlizy.middleware.cc.server.entity.CcPropertiesCriteria.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class CcPropertiesSqlProvider {


    public String countByExample(CcPropertiesCriteria example) {
    ...
    public String deleteByExample(CcPropertiesCriteria example) {

        SQL sql = new SQL();
        sql.DELETE_FROM("properties");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CcProperties record) {

        SQL sql = new SQL();
        sql.INSERT_INTO("properties");
    ...
    public String selectByExample(CcPropertiesCriteria example) {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        CcProperties record = (CcProperties) parameter.get("record");
        CcPropertiesCriteria example = (CcPropertiesCriteria) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(CcProperties record) {
    ...
    protected void applyWhere(SQL sql, CcPropertiesCriteria example, boolean includeExamplePhrase) {
